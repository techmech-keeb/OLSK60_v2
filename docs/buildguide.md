...
販売時は3-Split-Spaceレイアウトとなるよう、最下段には2Uのスタビライザーが2つ並んで取り付けられていますが、別途6.25Uのスタビライザーを用意して取り付けることも可能です。

取り付けるスタビライザーの位置は以下の通りです：
- バックスペースキー（2U）
- エンターキー（2U）
- 3-Split-Space（2U x 2）または 6.25U Space（6.25U）
...
4. VIAを使用する場合は、[GitHub Releases](https://github.com/techmech-keeb/OLSK60_v2/releases)からVIA用JSONファイルをダウンロードして読み込んでください。
